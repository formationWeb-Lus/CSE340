...
-- Clé étrangère pour classification
...
VALUES
  ...
  ('Aerocar International','Aerocar','1963','Are you sick of rushhour traffic? This car converts into an airplane to get you where you are going fast. Only 6 of these were made, get them while they last!','/images/aerocar.jpg','/images/aerocar-tn.jpg',700000,18956,'Red',1),
...
VALUES ('tony', 'stark', 'tonystark@gmail.com', 'iam1ronman');

-- Définir l'utilisateur en Admin
UPDATE account
SET account_type = 'Admin'
WHERE account_email = 'tonystark@gmail.com';

-- Supprimer le compte si besoin
DELETE FROM account
WHERE account_email = 'tonystark@gmail.com';
